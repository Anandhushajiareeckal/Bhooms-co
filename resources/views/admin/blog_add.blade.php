        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body card-main-three">
                    ...
                    <form class="form-floating" action="/admin/blog/store" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                        ...
                        <span class="">
                            <textarea class="form-control" id="TextArea" rows="8" cols="30" placeholder="Comment" name="discription" value=""required></textarea>
                            <label class="form-label" for="TextArea">Description</label><br>
                        </span>
                   
                        <div class="mb-4">
                            <span class="form-floating">
                                <input type="file" class="form-control" id="emailInput" placeholder="password" name="image" required>
