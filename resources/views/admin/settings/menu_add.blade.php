            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body card-main-three">
                        <h5 class="m-4">Add menu </h5>
                        <form class="form-floating" action="/admin/menu/store" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-4">
                                <span class="form-floating">
                                    <input type="text" class="form-control" id="TextInput" placeholder="Name" required name="name" >
                                    <label class="" for="TextInput">Menu Name</label>
                                </span>
                            </div>
