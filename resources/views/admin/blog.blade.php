        ...
        <div class="col-lg-12 col-md-12">
            <div class="card mb-3">
                <div class="card-header">
                    <h6 class="m-0">Blog </h6>
                    <div class="form-check form-switch table-toggle-one">
                        <a href="/admin/contents/blog" class="btn btn-primary ">Update content</a>
                    ...
                    <table class="myDataTable table table-hover align-middle mb-0" style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/admin/blog/{{$item->id}}" class="btn btn-primary">Edit</a>
                                    <a href="/admin/blog/{{$item->id}}/delete" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?')">Delete </a>
                                </td>
                            </tr>
                            @endfor
                        </tbody>
